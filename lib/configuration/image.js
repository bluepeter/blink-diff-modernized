...
var Image = Base.extend(
...

	{
		...
		isCropped: function () {
			...
			// Check if any crop dimensions are actually defined
			var rect = this._crop;
			return (rect.getLeft() !== undefined && rect.getLeft() !== null) ||
				(rect.getTop() !== undefined && rect.getTop() !== null) ||
				(rect.getWidth() !== undefined && rect.getWidth() !== null) ||
				(rect.getHeight() !== undefined && rect.getHeight() !== null);
		},
